...
module Rubychains::Prompt
  # = Prompt Templates
  #
  # Create a prompt with one input variable:
  #
  #     prompt = Rubychains::Prompt::PromptTemplate.new(template: "Tell me a {adjective} joke.", input_variables: ["adjective"])
  #     prompt.format(adjective: "funny") # "Tell me a funny joke."
  #
  # Create a prompt with multiple input variables:
  #
  #     prompt = Rubychains::Prompt::PromptTemplate.new(template: "Tell me a {adjective} joke about {content}.", input_variables: ["adjective", "content"])
  #     prompt.format(adjective: "funny", content: "chickens") # "Tell me a funny joke about chickens."
  #
  # Creating a PromptTemplate using just a prompt and no input_variables:
  #
  #     prompt = Rubychains::Prompt::PromptTemplate.from_template("Tell me a {adjective} joke about {content}.")
  ...
  #
  #     prompt = Rubychains::Prompt.load_from_path(file_path: "spec/fixtures/prompt/prompt_template.json")
  #     prompt.input_variables # ["adjective", "content"]
  #
  # Loading a new prompt template using a YAML file:
  #     prompt = Rubychains::Prompt.load_from_path(file_path: "spec/fixtures/prompt/prompt_template.yaml")
  #     prompt.input_variables #=> ["adjective", "content"]
  #
